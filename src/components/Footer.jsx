      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/reservation" className="hover:text-amber-300 transition-colors">
                  Reservation
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Link
                href="https://www.instagram.com/eytravelegypt"
              ...
              <Link
                href="https://www.facebook.com/share/19wmjzPp8h/"
        ...
        <div className="border-t border-stone-700 mt-12 pt-8 text-center text-stone-400">
          <p>
            ...
            <Link href="/sitemap" className="hover:text-amber-300 transition-colors hidden">
              Sitemap
            </Link>
          </p>
        </div>
