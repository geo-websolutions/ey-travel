    ...
    <div className="bg-stone-800/50 rounded-xl border border-stone-700 overflow-hidden">
      ...
      <div className="divide-y divide-stone-700">
        {recentTours.map((tour) => (
          <div key={tour.id} className="p-3 md:p-4 hover:bg-stone-700/30 transition-colors grid grid-cols-5 items-center">
            ...
            <div className="text-right">
              <p className="text-amber-400 font-bold text-sm md:text-base">${tour.pricing.basePrice}</p>
              <button
                onClick={() => setActiveTab('tours')}
