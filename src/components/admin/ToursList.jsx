...
export const ToursList = ({ tours, setActiveTab }) => {
  ...
  return (
    <div className="bg-stone-800/50 rounded-xl border border-stone-700 overflow-hidden">
      {/* Modal */}
      {selectedTour && <TourViewModal tour={selectedTour} onClose={() => setSelectedTour(null)} />}
      {editingTour && (
        <TourEditModal
          tour={editingTour}
      ...
      <div className="divide-y divide-stone-700">
        {filteredTours.map((tour) => (
          <div
            key={tour.id}
            className="p-3 md:p-4 hover:bg-stone-700/30 transition-colors grid grid-cols-12 items-center gap-2"
          >
            ...
            <div className="hidden md:block md:col-span-2 text-center">
              <p className="text-amber-400 font-bold">
                {tour.pricing.basePrice !== undefined
                  ...
                  : `Starting from $${tour.pricing.groupPrices[0].price}`}
              </p>
            </div>
