...
export default function HeroSection({ setIsSearching, isSearching, tours }) {
  ...
  return (
    <motion.div variants={container} className="text-center my-16">
      ...
      >
        Premium <span className="text-amber-400">Egypt Tour Packages</span> - Luxor, Aswan, Hurghada
        & More
      </motion.h1>
      ...
      >
        Experience 5,000 years of history with EY Travel Egypt tours. From the pyramids of Giza to
        the temples of Luxor and Red Sea resorts in Hurghada, we offer all-inclusive packages with
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            disabled={
              !isSearching &&
              Object.values(searchParams).every((val) =>
        ...
        {isSearching && (
          ...
          >
            <p className="text-stone-300">
              Found <span className="text-amber-400 font-semibold">{filteredTours.length}</span>{" "}
              tours matching your preferences
